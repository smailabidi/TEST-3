...
?>
	...
	<div class="post-body clearfix">
      ...
      <div class="category-single-post">
         <?php
            qoxag_post_categories(get_the_ID(), $qoxag_single_number_of_categries, 'contentpart', 'default');
         ?>
      </div>
      <?php } ?>
		...
		<header class="entry-header clearfix qoxag-grid-single">
			<?php 
            qoxag_post_categories(get_the_ID(), $qoxag_single_number_of_categries, 'contentpart', 'left-background');
